...
public class VirtualEClass extends VirtualEClassifier<EClass>
	...
	public EList<EClass> getESuperTypes() {
		...
		return new EcoreEList.UnmodifiableEList<>(this, EcorePackage.Literals.ECLASS__ESUPER_TYPES, types.size(),
				types.toArray());
	}
	...
	public EList<EClass> getEAllSuperTypes() {
		...
		// See @UnmodifiableEList.
		return new EcoreEList.UnmodifiableEList<>(this, EcorePackage.Literals.ECLASS__EALL_SUPER_TYPES, sups.size(),
				sups.toArray());
	}
	...
	public EList<EStructuralFeature> getEStructuralFeatures() {
		...
		// See @UnmodifiableElist
		return new EcoreEList.UnmodifiableEList<>(this, EcorePackage.Literals.ECLASS__ESTRUCTURAL_FEATURES, cs.size(),
				cs.toArray());
	}
	...
	public EList<EAttribute> getEAttributes() {
		...
		// See @UnmodifiableElist
		return new EcoreEList.UnmodifiableEList<>(this, EcorePackage.Literals.ECLASS__EATTRIBUTES, attrs.size(),
				attrs.toArray());
	}
	...
	public EList<EAttribute> getEAllAttributes() {
		...
		// See @UnmodifiableElist
		return new EcoreEList.UnmodifiableEList<>(this, EcorePackage.Literals.ECLASS__EALL_ATTRIBUTES, attrs.size(),
				attrs.toArray());
	}
	...
	public EList<EReference> getEReferences() {
		...
		// See @UnmodifiableElist
		return new EcoreEList.UnmodifiableEList<>(this, EcorePackage.Literals.ECLASS__EREFERENCES, refs.size(),
				refs.toArray());
	}
	...
	public EList<EReference> getEAllReferences() {
		...
		// See @UnmodifiableElist
		return new EcoreEList.UnmodifiableEList<>(this, EcorePackage.Literals.ECLASS__EALL_REFERENCES, refs.size(),
				refs.toArray());
	}
	...
	public EList<EReference> getEAllContainments() {
		...
		// See @UnmodifiableElist
		return new EcoreEList.UnmodifiableEList<>(this, EcorePackage.Literals.ECLASS__EALL_CONTAINMENTS,
				containments.size(), containments.toArray());
	}

	@Override
	public EList<EStructuralFeature> getEAllStructuralFeatures() {
		List<EStructuralFeature> cs = getVisibleFeatures();
		// ECrossReferenceList expects this method to be castable to
		// EClassImpl.FeatureSubsetSupplier.
		return new FeatureSupplierList<>(this, EcorePackage.Literals.ECLASS__ESTRUCTURAL_FEATURES, cs.size(),
				cs.toArray());
	}
	...
	class FeatureSupplierList<E> extends EcoreEList.UnmodifiableEList<E> implements EClassImpl.FeatureSubsetSupplier {
		...
		public FeatureSupplierList(InternalEObject owner, EStructuralFeature eStructuralFeature, int size,
				Object[] data) {
	...
	public boolean isSuperTypeOf(EClass someClass) {
		if (someClass instanceof VirtualEClass) {
			...
			return c.concrete() == this.concrete() || c.virtualSuperTypes.contains(this)
