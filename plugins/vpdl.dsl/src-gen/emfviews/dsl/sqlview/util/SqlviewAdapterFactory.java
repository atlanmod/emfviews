...
public class SqlviewAdapterFactory extends AdapterFactoryImpl
{
  ...
  protected SqlviewSwitch<Adapter> modelSwitch =
    new SqlviewSwitch<Adapter>()
    {
      ...
      @Override
      public Adapter caseJoinLeft(JoinLeft object)
      {
        return createJoinLeftAdapter();
      }
      @Override
      public Adapter caseJoinRight(JoinRight object)
      {
        return createJoinRightAdapter();
      }
      @Override
  ...
  /**
   * Creates a new adapter for an object of class '{@link emfviews.dsl.sqlview.SelectAttribute <em>Select Attribute</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '{@link emfviews.dsl.sqlview.Join <em>Join</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '{@link emfviews.dsl.sqlview.JoinLeft <em>Join Left</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
   ...
   * @generated
   */
  public Adapter createJoinLeftAdapter()
  {
    return null;
  }

  /**
   * Creates a new adapter for an object of class '{@link emfviews.dsl.sqlview.JoinRight <em>Join Right</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
   ...
   * @generated
   */
  public Adapter createJoinRightAdapter()
  {
    return null;
  }
  ...
  /**
   * Creates a new adapter for an object of class '{@link emfviews.dsl.sqlview.Relation <em>Relation</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '{@link emfviews.dsl.sqlview.EclExpression <em>Ecl Expression</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
