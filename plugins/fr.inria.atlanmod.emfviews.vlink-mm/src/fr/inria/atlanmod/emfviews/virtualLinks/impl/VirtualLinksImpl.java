...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Virtual Links</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link fr.inria.atlanmod.emfviews.virtualLinks.impl.VirtualLinksImpl#getVirtualLinks <em>Virtual Links</em>}</li>
 *   <li>{@link fr.inria.atlanmod.emfviews.virtualLinks.impl.VirtualLinksImpl#getLinkedElements <em>Linked Elements</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class VirtualLinksImpl extends MinimalEObjectImpl.Container implements VirtualLinks {
	...
	/**
	 * The cached value of the '{@link #getLinkedElements() <em>Linked Elements</em>}' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	public EList<VirtualLink> getVirtualLinks() {
		if (virtualLinks == null) {
			virtualLinks = new EObjectContainmentEList<VirtualLink>(VirtualLink.class, this, VirtualLinksPackage.VIRTUAL_LINKS__VIRTUAL_LINKS);
		}
		return virtualLinks;
	}
	...
	public EList<LinkedElement> getLinkedElements() {
		if (linkedElements == null) {
			linkedElements = new EObjectContainmentEList<LinkedElement>(LinkedElement.class, this, VirtualLinksPackage.VIRTUAL_LINKS__LINKED_ELEMENTS);
		}
