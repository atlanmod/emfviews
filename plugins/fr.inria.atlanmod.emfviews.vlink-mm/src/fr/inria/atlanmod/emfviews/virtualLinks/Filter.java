 ...
 * <ul>
 *   <li>{@link fr.inria.atlanmod.emfviews.virtualLinks.Filter#getFilteredElement <em>Filtered Element</em>}</li>
 *   <li>{@link fr.inria.atlanmod.emfviews.virtualLinks.Filter#getOclQuery <em>Ocl Query</em>}</li>
 *   <li>{@link fr.inria.atlanmod.emfviews.virtualLinks.Filter#isFilterOnlyEstructuralFeatures <em>Filter Only Estructural Features</em>}</li>
 * </ul>
 * </p>
 *
...
public interface Filter extends VirtualLink {
	...
	/**
	 * Sets the value of the '{@link fr.inria.atlanmod.emfviews.virtualLinks.Filter#getFilteredElement <em>Filtered Element</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Sets the value of the '{@link fr.inria.atlanmod.emfviews.virtualLinks.Filter#getOclQuery <em>Ocl Query</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the value of the '<em><b>Filter Only Estructural Features</b></em>' attribute.
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Filter Only Estructural Features</em>' attribute isn't clear,
	 * there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Filter Only Estructural Features</em>' attribute.
	...
	/**
	 * Sets the value of the '{@link fr.inria.atlanmod.emfviews.virtualLinks.Filter#isFilterOnlyEstructuralFeatures <em>Filter Only Estructural Features</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param value the new value of the '<em>Filter Only Estructural Features</em>' attribute.
