...
public class EmfViewsUtil
{
	...
	public static URI toURI(String resourcePath) throws URISyntaxException
	{
		...
		IResource resource=workspaceRoot.findMember((resourcePath.startsWith("/") ? resourcePath : "/"+resourcePath));
		
		URI resourceUri = (resource!=null ? resource.getLocationURI() : new java.net.URI(resourcePath));
	...
	public static void persistLinksModel(VirtualLinks linksModel, org.eclipse.emf.common.util.URI theUri) throws IOException
	{
	...
	public static LinkedElement createLinkedElement(String name, String modelRef, String elementRef,String features)
	{
	...
	public static void associateFilters(VirtualLinks virtualLinks,Filter filter,LinkedElement linkedElement)
	{
