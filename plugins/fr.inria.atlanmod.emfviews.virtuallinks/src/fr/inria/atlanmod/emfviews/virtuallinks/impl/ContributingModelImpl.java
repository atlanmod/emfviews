 ...
 * </p>
 * <ul>
 *   <li>{@link fr.inria.atlanmod.emfviews.virtuallinks.impl.ContributingModelImpl#getURI <em>URI</em>}</li>
 *   <li>{@link fr.inria.atlanmod.emfviews.virtuallinks.impl.ContributingModelImpl#getConcreteElements <em>Concrete Elements</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ContributingModelImpl extends MinimalEObjectImpl.Container implements ContributingModel {
  /**
  ...
  public void setURI(String newURI) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, VirtualLinksPackage.CONTRIBUTING_MODEL__URI, oldURI, uri));
  }
  ...
  public EList<ConcreteElement> getConcreteElements() {
    if (concreteElements == null) {
      concreteElements = new EObjectContainmentWithInverseEList<ConcreteElement>(ConcreteElement.class, this, VirtualLinksPackage.CONTRIBUTING_MODEL__CONCRETE_ELEMENTS, VirtualLinksPackage.CONCRETE_ELEMENT__MODEL);
    }
  ...
  public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
    switch (featureID) {
      case VirtualLinksPackage.CONTRIBUTING_MODEL__CONCRETE_ELEMENTS:
        return ((InternalEList<InternalEObject>)(InternalEList<?>)getConcreteElements()).basicAdd(otherEnd, msgs);
    }
