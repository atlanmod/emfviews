 ...
 * @generated
 */
public class ConcreteElementImpl extends LinkedElementImpl implements ConcreteElement {
  /**
  ...
  public ContributingModel getModel() {
    if (eContainerFeatureID() != VirtualLinksPackage.CONCRETE_ELEMENT__MODEL) return null;
  ...
  public NotificationChain basicSetModel(ContributingModel newModel, NotificationChain msgs) {
    msgs = eBasicSetContainer((InternalEObject)newModel, VirtualLinksPackage.CONCRETE_ELEMENT__MODEL, msgs);
    return msgs;
  }
  ...
  public void setModel(ContributingModel newModel) {
    if (newModel != eInternalContainer() || (eContainerFeatureID() != VirtualLinksPackage.CONCRETE_ELEMENT__MODEL && newModel != null)) {
      ...
      if (newModel != null)
        msgs = ((InternalEObject)newModel).eInverseAdd(this, VirtualLinksPackage.CONTRIBUTING_MODEL__CONCRETE_ELEMENTS, ContributingModel.class, msgs);
      msgs = basicSetModel(newModel, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, VirtualLinksPackage.CONCRETE_ELEMENT__MODEL, newModel, newModel));
  }
  ...
  public void setPath(String newPath) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, VirtualLinksPackage.CONCRETE_ELEMENT__PATH, oldPath, path));
  }
  ...
  public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
    switch (eContainerFeatureID()) {
      case VirtualLinksPackage.CONCRETE_ELEMENT__MODEL:
        return eInternalContainer().eInverseRemove(this, VirtualLinksPackage.CONTRIBUTING_MODEL__CONCRETE_ELEMENTS, ContributingModel.class, msgs);
    }
