 ...
 * </p>
 * <ul>
 * <li>{@link fr.inria.atlanmod.emfviews.virtuallinks.VirtualAssociation#getSource <em>Source</em>}</li>
 * <li>{@link fr.inria.atlanmod.emfviews.virtuallinks.VirtualAssociation#getTarget <em>Target</em>}</li>
 * <li>{@link fr.inria.atlanmod.emfviews.virtuallinks.VirtualAssociation#getLowerBound <em>Lower Bound</em>}</li>
 * <li>{@link fr.inria.atlanmod.emfviews.virtuallinks.VirtualAssociation#getUpperBound <em>Upper Bound</em>}</li>
 * <li>{@link fr.inria.atlanmod.emfviews.virtuallinks.VirtualAssociation#getOpposite <em>Opposite</em>}</li>
 * <li>{@link fr.inria.atlanmod.emfviews.virtuallinks.VirtualAssociation#isComposition <em>Composition</em>}</li>
 * </ul>
 *
 * @see fr.inria.atlanmod.emfviews.virtuallinks.VirtualLinksPackage#getVirtualAssociation()
 * @model
 * @generated
 */
public interface VirtualAssociation extends VirtualLink, VirtualElement, Association {
   ...
   * @see fr.inria.atlanmod.emfviews.virtuallinks.VirtualLinksPackage#getVirtualAssociation_Source()
   * @model required="true"
   * @generated
   */
  Concept getSource();
  ...
  /**
   * Sets the value of the '{@link fr.inria.atlanmod.emfviews.virtuallinks.VirtualAssociation#getSource
   ...
   * @see fr.inria.atlanmod.emfviews.virtuallinks.VirtualLinksPackage#getVirtualAssociation_Target()
   * @model required="true"
   * @generated
   */
  Concept getTarget();
  ...
  /**
   * Sets the value of the '{@link fr.inria.atlanmod.emfviews.virtuallinks.VirtualAssociation#getTarget
   ...
   * @see fr.inria.atlanmod.emfviews.virtuallinks.VirtualLinksPackage#getVirtualAssociation_LowerBound()
  ...
  /**
   * Sets the value of the '{@link fr.inria.atlanmod.emfviews.virtuallinks.VirtualAssociation#getLowerBound <em>Lower
   ...
   * @see fr.inria.atlanmod.emfviews.virtuallinks.VirtualLinksPackage#getVirtualAssociation_UpperBound()
   * @model unique="false" required="true" ordered="false"
   * @generated
   */
  int getUpperBound();
  ...
  /**
   * Sets the value of the '{@link fr.inria.atlanmod.emfviews.virtuallinks.VirtualAssociation#getUpperBound <em>Upper
   * Bound</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   *
   ...
   * @see fr.inria.atlanmod.emfviews.virtuallinks.VirtualLinksPackage#getVirtualAssociation_Opposite()
   * @model ordered="false"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link fr.inria.atlanmod.emfviews.virtuallinks.VirtualAssociation#getOpposite
   ...
   * @see fr.inria.atlanmod.emfviews.virtuallinks.VirtualLinksPackage#getVirtualAssociation_Composition()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link fr.inria.atlanmod.emfviews.virtuallinks.VirtualAssociation#isComposition
