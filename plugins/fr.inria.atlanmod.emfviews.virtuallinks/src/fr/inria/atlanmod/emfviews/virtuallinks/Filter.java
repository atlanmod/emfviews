 ...
 * </p>
 * <ul>
 * <li>{@link fr.inria.atlanmod.emfviews.virtuallinks.Filter#getTarget <em>Target</em>}</li>
 * </ul>
 *
...
public interface Filter extends VirtualLink {
   ...
   * @see fr.inria.atlanmod.emfviews.virtuallinks.VirtualLinksPackage#getFilter_Target()
   * @model required="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link fr.inria.atlanmod.emfviews.virtuallinks.Filter#getTarget <em>Target</em>}' reference.
