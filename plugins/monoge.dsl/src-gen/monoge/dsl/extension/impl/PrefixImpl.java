 ...
 * <ul>
 *   <li>{@link monoge.dsl.extension.impl.PrefixImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PrefixImpl extends MinimalEObjectImpl.Container implements Prefix
{
  ...
  {
    return ExtensionPackage.Literals.PREFIX;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ExtensionPackage.PREFIX__NAME, oldName, name));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ExtensionPackage.PREFIX__NAME:
        return getName();
    }
