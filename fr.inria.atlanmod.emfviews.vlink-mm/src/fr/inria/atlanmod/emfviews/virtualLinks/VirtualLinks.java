...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>Virtual Links</b></em>'.
 * <!-- end-user-doc -->
 *
 * <p>
 * The following features are supported:
 * <ul>
 *   <li>{@link fr.inria.atlanmod.emfviews.virtualLinks.VirtualLinks#getVirtualLinks <em>Virtual Links</em>}</li>
 *   <li>{@link fr.inria.atlanmod.emfviews.virtualLinks.VirtualLinks#getLinkedElements <em>Linked Elements</em>}</li>
 * </ul>
 * </p>
 *
...
public interface VirtualLinks extends EObject {
	...
	/**
	 * Returns the value of the '<em><b>Linked Elements</b></em>' containment reference list.
	 * The list contents are of type {@link fr.inria.atlanmod.emfviews.virtualLinks.LinkedElement}.
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Linked Elements</em>' containment reference list isn't clear,
	 * there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Linked Elements</em>' containment reference list.
