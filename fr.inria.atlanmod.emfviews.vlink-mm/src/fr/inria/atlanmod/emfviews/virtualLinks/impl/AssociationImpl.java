 ...
 * <ul>
 *   <li>{@link fr.inria.atlanmod.emfviews.virtualLinks.impl.AssociationImpl#getLowerBound <em>Lower Bound</em>}</li>
 *   <li>{@link fr.inria.atlanmod.emfviews.virtualLinks.impl.AssociationImpl#getUpperBound <em>Upper Bound</em>}</li>
 *   <li>{@link fr.inria.atlanmod.emfviews.virtualLinks.impl.AssociationImpl#getAssociationTypeName <em>Association Type Name</em>}</li>
 *   <li>{@link fr.inria.atlanmod.emfviews.virtualLinks.impl.AssociationImpl#getOpposite <em>Opposite</em>}</li>
 *   <li>{@link fr.inria.atlanmod.emfviews.virtualLinks.impl.AssociationImpl#getSourceElement <em>Source Element</em>}</li>
 *   <li>{@link fr.inria.atlanmod.emfviews.virtualLinks.impl.AssociationImpl#getTargetElements <em>Target Elements</em>}</li>
 *   <li>{@link fr.inria.atlanmod.emfviews.virtualLinks.impl.AssociationImpl#getOclExpression <em>Ocl Expression</em>}</li>
 *   <li>{@link fr.inria.atlanmod.emfviews.virtualLinks.impl.AssociationImpl#getSourceAttribute <em>Source Attribute</em>}</li>
 *   <li>{@link fr.inria.atlanmod.emfviews.virtualLinks.impl.AssociationImpl#getTargetAttribute <em>Target Attribute</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AssociationImpl extends VirtualLinkImpl implements Association {
	...
	/**
	 * The default value of the '{@link #getAssociationTypeName() <em>Association Type Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * The cached value of the '{@link #getAssociationTypeName() <em>Association Type Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getAssociationTypeName()
	 * @generated
	...
	public void setLowerBound(int newLowerBound) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VirtualLinksPackage.ASSOCIATION__LOWER_BOUND, oldLowerBound, lowerBound));
	}
	...
	public void setUpperBound(int newUpperBound) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VirtualLinksPackage.ASSOCIATION__UPPER_BOUND, oldUpperBound, upperBound));
	}
	...
	public void setAssociationTypeName(String newAssociationTypeName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VirtualLinksPackage.ASSOCIATION__ASSOCIATION_TYPE_NAME, oldAssociationTypeName, associationTypeName));
	}
	...
	public Association getOpposite() {
		if (opposite != null && opposite.eIsProxy()) {
			...
			if (opposite != oldOpposite) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, VirtualLinksPackage.ASSOCIATION__OPPOSITE, oldOpposite, opposite));
			}
		}
		return opposite;
	}
	...
	public void setOpposite(Association newOpposite) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VirtualLinksPackage.ASSOCIATION__OPPOSITE, oldOpposite, opposite));
	}
	...
	public LinkedElement getSourceElement() {
		if (sourceElement != null && sourceElement.eIsProxy()) {
			...
			if (sourceElement != oldSourceElement) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, VirtualLinksPackage.ASSOCIATION__SOURCE_ELEMENT, oldSourceElement, sourceElement));
			}
		}
	...
	public void setSourceElement(LinkedElement newSourceElement) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VirtualLinksPackage.ASSOCIATION__SOURCE_ELEMENT, oldSourceElement, sourceElement));
	}
	...
	public EList<LinkedElement> getTargetElements() {
		if (targetElements == null) {
			targetElements = new EObjectResolvingEList<LinkedElement>(LinkedElement.class, this, VirtualLinksPackage.ASSOCIATION__TARGET_ELEMENTS);
		}
	...
	public void setOclExpression(String newOclExpression) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VirtualLinksPackage.ASSOCIATION__OCL_EXPRESSION, oldOclExpression, oclExpression));
	}
	...
	public void setSourceAttribute(String newSourceAttribute) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VirtualLinksPackage.ASSOCIATION__SOURCE_ATTRIBUTE, oldSourceAttribute, sourceAttribute));
	}
	...
	public void setTargetAttribute(String newTargetAttribute) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VirtualLinksPackage.ASSOCIATION__TARGET_ATTRIBUTE, oldTargetAttribute, targetAttribute));
	}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case VirtualLinksPackage.ASSOCIATION__ASSOCIATION_TYPE_NAME:
				return ASSOCIATION_TYPE_NAME_EDEFAULT == null ? associationTypeName != null : !ASSOCIATION_TYPE_NAME_EDEFAULT.equals(associationTypeName);
			case VirtualLinksPackage.ASSOCIATION__OPPOSITE:
