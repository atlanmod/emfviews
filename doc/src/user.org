...
3. by using the EMF Views API [[*Programmatic API][programmatically]].
...
By default, EMF Views ca use ECL files to create weaving models.  Such typically
contain one rule for each virtual association.  Here is an example ECL file
